...
Ce projet permet la gestion de livres et d'utilisateurs, de leurs lectures et de suggérer des livres.

Pour lancer le programme :
Lancer : main.py ('python3 main.py')

Vous pouvez vous enregistrer en tappant "new" ou utiliser les utilisateurs prédéfinis dans './data/readers.txt' (même que sur Moodle Sujet Projet)
